...
class Exercise1 {
    ...
    void sortPersonsByLastNameThenFirstNameUsingArraysSortAnonymousComparator() {
        ...
        Arrays.sort(persons, new Comparator<Person>() {
            ...
            public int compare(Person o1, Person o2) {
                ...
                return (compareResult == 0) ? o1.getFirstName().compareTo(o2.getFirstName()) : compareResult;
            }
        });
    ...
    void findFirstWithAge30UsingGuavaPredicate() {
        ...
        Predicate<Person> isAgeEquals30 = new Predicate<Person>() {
            @Override
        ...
        Person person = FluentIterable.from(persons).firstMatch(isAgeEquals30).orNull();
